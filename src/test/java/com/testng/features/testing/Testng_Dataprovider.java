...
public class Testng_Dataprovider extends Base_Class {
	...
	@DataProvider
	private Object[][] nameforhotel() {
		Object [][]obs = new Object[1][2];
		obs[0][0] = "Mohammad";
		obs[0][1] = "Sultan";
		return obs;
	}
	...
	@Test(priority = 0, dataProvider = "nameforhotel")
	private void bookingandselecting(String fname, String lname) {
		waitimplicit();
